                    ...
                    <div class="col-md-3">
                        <div class="dashboard_nav_item">
                            <ul>
                                ...
                                <li><a href="<?= wp_logout_url(home_url()) ?>"><i class="login-icon ti-power-off"></i>
                                        Se déconnecter</a></li>
        ...
        <div class="widget-boxed">
            ...
            <div class="widget-boxed-body">
                <form @submit="submitNewPassword" method="post" action="" novalidate>
                    ...
                    <div v-if="validators.length" style="margin-top: 40px; padding-left: 20px;">
                ...
                <div class="widget-boxed-body">
                    <div class="side-list no-border">
                        <ul>
                            ...
                            <li v-if="currentUser.meta.city != ''">
                                <i class="ti-world padd-r-10"></i>{{currentUser.meta.city}}
                            </li>
                            <li v-if="currentUser.meta.phone != ''">
                                <i class="ti-mobile padd-r-10"></i>{{currentUser.meta.phone}}
                            </li>
                            <li><i class="ti-email padd-r-10"></i>{{currentUser.email}}</li>
